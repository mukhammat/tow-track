...
export class OrderController implements IOrderController {
    ...
    private routers() {
        ...
        this.router.patch("/cancel/:orderId", zValidator("param", IdSchema), this.cancelOrder.bind(this));
        this.router.patch("/complete/:orderId", zValidator("param", IdSchema), this.completeOrder.bind(this));
